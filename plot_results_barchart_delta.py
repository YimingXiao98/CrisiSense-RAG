...
raw = {
    "Gemini25": {
        ...
        "damage": [11.88, 12.52, 10.93, 12.31],
    },
    "Gemini3": {
        "extent": [11.10, 11.50, 17.70, 11.11],
        "damage": [10.09, 11.12, 10.13, 10.14],
    },
    "Qwen": {
        "extent": [22.06, 22.93, 27.10, 19.64],
        "damage": [11.88, 12.05, 13.19, 11.23],
    },
    "GPT": {
        "extent": [17.48, 18.41, 14.68,  8.86],
        "damage": [11.14, 11.49, 12.06, 14.47],
    },
}
